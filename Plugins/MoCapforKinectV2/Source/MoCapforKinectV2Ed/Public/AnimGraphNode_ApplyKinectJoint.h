...
#include "AnimGraphNode_ApplyKinectJoint.generated.h"

UCLASS(meta = (Keywords = "MoCapForKinectV2"))
class MOCAPFORKINECTV2ED_API UAnimGraphNode_ApplyKinectJoint : public UAnimGraphNode_SkeletalControlBase
{
	GENERATED_UCLASS_BODY()
	
public:
	UPROPERTY(EditAnywhere, Category = "Settings")
		FAnimNode_ApplyKinectJoint Node;
